...
def test_score_route():
    req = {
        ...
        "segments": [
            {"start_lat": 53.34, "start_lon": -6.26, "end_lat": 53.341, "end_lon": -6.261},
            {"start_lat": 53.341, "start_lon": -6.261, "end_lat": 53.342, "end_lon": -6.262}
        ],
...
def test_safety_factors_and_weights():
    ...
    w_req = {
        "user_id": "usr_demo",
        "weights": {
            "cctv_coverage": 0.2, "street_lighting": 0.2, "business_activity": 0.2,
            "crime_rate": 0.2, "pedestrian_traffic": 0.2
        }
    }

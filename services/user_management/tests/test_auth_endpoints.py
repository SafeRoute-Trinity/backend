...
def test_get_current_user_with_valid_jwt_returns_user_data(
...
def test_get_user_with_valid_jwt_succeeds(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_get_user_with_mismatched_jwt_returns_403(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_update_preferences_with_valid_jwt_succeeds(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_update_preferences_with_expired_jwt_returns_401(
...
def test_update_preferences_with_mismatched_user_returns_403(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_upsert_trusted_contact_requires_valid_jwt(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_list_trusted_contacts_requires_valid_jwt(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_auth0_verify_endpoint_with_valid_jwt(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_protected_endpoint_handles_auth0_sub_format(
    mock_jwks_request, create_valid_jwt
):
    """
...
def test_update_preferences_without_jwt_returns_403():
    ...
    response = client.post(
        "/v1/users/some-user/preferences",
        json=preferences
    )
